...
class WeatherConditionDescriptor(object):
    ...
    descriptions = {
        WeatherConditions.THUNDERSTORM: {
            "de_DE": ["voraussichtlich Gewitterstürme"],
        ...
        WeatherConditions.SUN: {
            "de_DE": ["Sonnenschein", "voraussichtlich sonnig"],
        ...
        WeatherConditions.UNKNOWN: {
            "de_DE": ["Unbekannte Wetterbedingungen"],
